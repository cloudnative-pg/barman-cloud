...
func (in *DataBackupConfiguration) DeepCopyInto(out *DataBackupConfiguration) {
	*out = *in
	...
	if in.ShowAdditionalCommandArgs != nil {
		in, out := &in.ShowAdditionalCommandArgs, &out.ShowAdditionalCommandArgs
		*out = make([]string, len(*in))
		copy(*out, *in)
	}
	if in.ListAdditionalCommandArgs != nil {
		in, out := &in.ListAdditionalCommandArgs, &out.ListAdditionalCommandArgs
		*out = make([]string, len(*in))
		copy(*out, *in)
	}
}
